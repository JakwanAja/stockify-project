        ...
        <form method="POST" action="{{ route('admin.suppliers.update', $supplier->id) }}">
            ...
            <div class="mb-6">
                ...
                <textarea id="address" name="address" rows="3"
                    ...
                    class="w-full px-4 py-2.5 text-sm border border-gray-200 bg-slate-50 rounded-lg outline-none transition focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 resize-none">{{ old('address', $supplier->address) }}</textarea>
            </div>
