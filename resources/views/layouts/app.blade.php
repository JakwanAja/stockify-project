...
<body class="bg-gray-50 antialiased h-full">
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 flex-shrink-0 bg-white border-r border-gray-200 flex flex-col h-full overflow-y-auto">
            {{-- Signature accent strip: echoes the red ribbon in the logo --}}
            <div class="h-1 w-full bg-red-600 flex-shrink-0"></div>
            ...
            <div class="border-t border-gray-200 p-4">
                <div class="flex items-center gap-3">
                    <div class="w-9 h-9 rounded-full bg-red-50 border border-red-200 flex items-center justify-center flex-shrink-0">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" title="Logout" class="text-gray-400 hover:text-red-600 transition">
